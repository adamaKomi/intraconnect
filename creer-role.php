                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="traitement/add-role.php" enctype="multipart/form-data">
                                <div class="col mb-3">
                                    <label for="nomRole" class="col-12 col-form-label">Nom du role<span class="etoile">*</span></label>
                                    <div class="col-12">
                                        <input id="nomRole" type="text" class="form-control" name="nomRole" required value="<?php echo isset($_SESSION['nomRole']) ? $_SESSION['nomRole'] : "";
                                                                                                                            unset($_SESSION['nomRole']); ?>">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary" name="ajouterRole">Ajouter role</button>
                                        <input type="reset" class="btn btn-warning" value="Effacer">
                                    </div>
                                </div>
                                <div class="col col-2 mb-3 w-100">
                                    <div class="col-sm-10 w-100">
                                        <a type="submit" class="btn btn-danger" href="creer-role.php">Annuler</a>
                                    </div>
                                </div>
                                <p style="font-style:italic">Obligatoire (<span class="etoile">*</span>)</p>
                                <?php if (isset($_SESSION['roleError'])) { ?>
                                    <p><span class="error-message"><?php echo $_SESSION['roleError'];
                                                                    unset($_SESSION['roleError']); ?></span></p>
                                <?php } ?>
